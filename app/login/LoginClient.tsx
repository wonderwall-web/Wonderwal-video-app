  ...
  return (
    <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 420, border: "1px solid #333", borderRadius: 12, padding: 18 }}>
        <h1 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>Wonderwal Login</h1>
        <div style={{ fontSize: 12, opacity: 0.8, marginBottom: 14 }}>
          Device: <b>{maskedDevice || "..."}</b>
        </div>
          ...
          {err ? (
            <div style={{ fontSize: 12, color: "#ff6b6b", marginTop: 4 }}>
              ...
              <div style={{ opacity: 0.85, marginTop: 4 }}>
                Kalau <b>DEVICE_MISMATCH</b>, admin reset dengan mengosongkan kolom <b>device_id</b> di sheet.
              </div>
            </div>
          ) : null}
        </form>
